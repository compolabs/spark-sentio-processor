...
export type SparkRegistryConfigurables = Partial<{
  OWNER: AddressInput;
...
const abi = {
  ...
  "concreteTypes": [
    ...
    {
      "type": "(struct std::address::Address, u32)",
      "concreteTypeId": "24adc22ce19c83012fe99cf2fa649f86e6e8ce9053543d9c641f907273616e2a",
      "metadataTypeId": 0
    },
    {
  ...
  "functions": [
    {
      "inputs": [],
      "name": "config",
      "output": "24adc22ce19c83012fe99cf2fa649f86e6e8ce9053543d9c641f907273616e2a",
      "attributes": [
        {
          "name": "doc-comment",
          "arguments": [
...
export class SparkRegistryInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class SparkRegistry extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: SparkRegistryInterface;
  declare functions: {
